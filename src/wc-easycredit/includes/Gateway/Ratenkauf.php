...
class Ratenkauf extends GatewayAbstract
{
    ...
    public function _construct()
    {
        ...
        $this->method_description = 'easyCredit-Ratenkauf - Join today to get the simplest way of partial payment for your POS and E-Commerce. easyCredit-Ratenkauf gives you the opportunity to offer installments as an additional payment method in your German WooCommerce store.';
