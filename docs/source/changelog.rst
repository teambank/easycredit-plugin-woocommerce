...
- Kompatibilität wooCommerce Germanized: Bestätigung der AGB erst bei Bestellabschluss (Classic und Blocks)
- Kompatibilität WooCommerce German Market: Bestätigung der AGB u. Versanddienstleister erst bei Bestellabschluss (Classic und Blocks)
- Native WooCommerce-AGB-Checkbox: Bestätigung der AGB erst bei Bestellabschluss (Classic und Blocks)
